...
public:
	...
	bool execute(uint8_t byte);	// return true when a correct packet is decoded (UDP)
	bool execute(uint8_t* packet,int length); // return true when a correct packet is decoded (other)
