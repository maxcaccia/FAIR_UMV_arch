/*
 * LoggerBlueBoatLPRI_launcher.cpp
 *
...
int main(int argc, char* argv[])
{
	...
	//
	if(thrProperties.moduleName=="LOGGER_BLUEBOAT_LPRI") {
		genericThread = new LoggerBlueBoatLPRIthread();
	}
	else {
		printf("ERROR: LoggerBlueBoatLPRIthread not implemented!\n"); fflush(stdout);
		return 0;
	}
