...
int main(int argc, char* argv[])
{
	...
	//***** insert your code here ************************************
	//
	if(thrProperties.moduleName=="BLUEBOAT_HW_SIM") {
		genericThread = new BlueBoatHwSimThread();
	}
	else {
		printf("ERROR: BlueBoatHwSimThread not implemented!\n"); fflush(stdout);
		return 0;
	}
	//***** end insert your code *************************************
	//
