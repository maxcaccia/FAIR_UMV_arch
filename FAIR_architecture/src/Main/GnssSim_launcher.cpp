...
int main(int argc, char* argv[])
{
	...
	if (argc < 3) {
		...
		printf("Wrong parameter number\n\t<module>_launcher  <threadName> <serviceUDPtimeOut> <true/false>\n");
		fflush(stdout);
		return -1;
	}
	...
	//***** insert your code here ************************************
	//
	if(thrProperties.moduleName=="GNSS_SIM") {
		genericThread = new GnssSimThread();
	}
	else {
		printf("ERROR: GnssSimThread not implemented!\n"); fflush(stdout);
		return 0;
	}
	//***** end insert your code *************************************
	//
